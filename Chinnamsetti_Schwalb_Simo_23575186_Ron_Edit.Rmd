...
```{r}
df.horse2 <- subset(df.horses, select=c(horse, date, course, off, type, class, dist_m, going, ran, pos, draw, age, sex, lbs, secs, dec, jockey, trainer, or, rpr, sire, dam, damsire, owner, origin, EVENT_TYPE, WIN, BSP_WIN, IImp_Perc_WIN, PLACE, BSP_PLACE, Imp_Perc_PLACE))
