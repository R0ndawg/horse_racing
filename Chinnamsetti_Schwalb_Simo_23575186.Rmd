...
```
THESE LAST 2 DON'T BELONG TO LINEAR MODELS!
...
legend("topleft",
       pch=19,
       legend=c("lost","won"), # THESE ARE MANUALLY PROVIDED -> HOW CAN I KNOW WHICH IS WHICH???
       col=c("blue","red"))
```
###########################################################
JUST TO CHECK WHY GRAPH LOOKS BAD....
