...
```{r}
df.horse <- subset(df.horse, select=c(date, race_name,type, class, dist_m, going, ran, pos, draw, horse, age, sex, lbs, hg, secs, dec, jockey, trainer, prize))
...
For some of the models, we will need a binary outcome variable. 
The "won" variable is not ideal because there will be a lot less 1s than 0s (approx. 10-12 times less). 
Thus, let us also create a "place" variable, indicating whether the horse finished in the top 3. 
```{r}
